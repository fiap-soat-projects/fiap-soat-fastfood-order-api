...
public class GetAllByStatusAsyncTests : OrderGatewayTestsBase
{
    [Fact]
    public async Task Have_GetAllByStatusAsync_When_Found_Then_Returns_PaginatedDomain()
    {
        #region Arrange
        ...
        // Act
        var result = await _sut.GetAllByStatusAsync(status, page, size, CancellationToken.None);
