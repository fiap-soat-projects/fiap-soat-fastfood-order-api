...
public class GetActivePaginateAsyncTests : OrderGatewayTestsBase
{
    [Fact]
    public async Task Have_GetActivePaginateAsync_When_Found_Then_Returns_PaginatedDomain()
    {
        #region Arrange
        var page = 1;
        var size = 10;
        ...
        // Act
        var result = await _sut.GetActivePaginateAsync(
            page, 
            size,
